...
- `generated_at`: 2026-05-14T14:49:14Z
- `root`: /Users/shwoo/mydir/AI/AI_architecture

| area | files | lines | navigation entry points |
| --- | ---: | ---: | --- |
| `agents` | 4 | 96 | - |
| `docs` | 52 | 4255 | `AGENTS.md`, `docs/AGENTS.md` |
| `other` | 111 | 14446 | `.agents/skills/brainstorming/SKILL.md`, `.agents/skills/code-review-expert/SKILL.md`, `.agents/skills/codex-skill-creator/SKILL.md` |
| `reference` | 14 | 1255 | `references.yaml`, `research/AGENTS.md` |
| `rules` | 25 | 1032 | `manifest.yaml` |
| `runtime` | 18 | 1137 | `runtime/AGENTS.md` |
| `scripts` | 81 | 21261 | `scripts/AGENTS.md`, `scripts/agent-flow.py`, `scripts/quality-gate.py` |
