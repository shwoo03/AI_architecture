...
| `rules` | 27 | 1364 | `manifest.yaml` |
| `runtime` | 28 | 7033 | `runtime/AGENTS.md` |
| `scripts` | 85 | 24209 | `scripts/AGENTS.md`, `scripts/agent-flow.py`, `scripts/quality-gate.py` |
