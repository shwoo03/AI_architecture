...
- 문서나 규칙 변경: `python scripts/verify-skeleton.py`
- 후보 카드 변경: `python scripts/validate-reference-candidates.py`
- dry-run 제안 변경: `python scripts/validate-reference-proposals.py`
...
- 장부: `python scripts/reference-copy-ledger.py add ...`로 `runtime/reference-copy-ledger.jsonl` append
- 검증: `python scripts/reference-copy-ledger.py check`, `python scripts/security-scan.py --strict`
